...
Revision ID: a71d0b685a0d
Revises: 
Create Date: 2025-12-10 13:37:41.486882
...
def upgrade() -> None:
    ...
    sa.Column('user_role', sa.Enum('ROOT', 'ADMIN', 'USER', name='roles'), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
